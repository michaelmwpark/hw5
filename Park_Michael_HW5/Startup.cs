...
namespace Park_Michael_HW5
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:fa21parkmichaelhw5.database.windows.net,1433;Initial Catalog=fa21parkmichaelhw5;Persist Security Info=False;User ID=MISAdmin;Password=Password123;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
